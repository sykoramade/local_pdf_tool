...
export default function SignupPage() {
  ...
  async function handleEmailSignUp(e: React.FormEvent) {
    ...
    // signInWithOtp creates the account if it doesn't exist
        ...
        {step === 'entry' ? (
          <>
            ...
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,.45)', margin: '0 0 22px' }}>
              No credit card. No uploads to a server. Just edit PDFs.
            </p>
            ...
            >
              ...
              <span style={{ padding: '0 10px', fontSize: 12, color: 'rgba(255,255,255,.28)' }}>
                or
              </span>
              <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,.08)' }} />
            </div>
            ...
            >
              We email you a one-click sign-in link. No password.
            </p>

            <p style={{ fontSize: 12, color: 'rgba(255,255,255,.28)', textAlign: 'center', marginTop: 8 }}>
          ...
          <div style={{ textAlign: 'center', padding: '8px 0' }}>
            ...
            >
              ...
              <strong style={{ color: '#f4f6fc' }}>{email}</strong>. Click it to activate
              your account.
            </p>
            <button
