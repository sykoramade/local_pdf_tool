    ...
    <main className="min-h-screen" style={{ background: '#0b0d14' }}>
      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-white mb-3">How PDF compression works</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-white mb-3">What this tool does and doesn&apos;t compress</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-white mb-3">When to compress vs. when not to</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-lg p-4" style={{ background: 'rgba(34,211,160,.08)', border: '1px solid rgba(34,211,160,.2)' }}>
              <p className="text-sm font-medium mb-2" style={{ color: '#22d3a0' }}>Good candidates</p>
              <ul className="text-sm space-y-1 list-disc list-inside" style={{ color: 'rgba(34,211,160,.75)' }}>
            ...
            <div className="rounded-lg p-4" style={{ background: 'rgba(255,255,255,.04)', border: '1px solid rgba(255,255,255,.08)' }}>
              <p className="text-sm font-medium mb-2" style={{ color: 'rgba(255,255,255,.7)' }}>Limited benefit</p>
              <ul className="text-sm space-y-1 list-disc list-inside" style={{ color: 'rgba(255,255,255,.5)' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-white mb-3">Why no upload is a real privacy advantage</h2>
          <p className="leading-relaxed" style={{ color: 'rgba(255,255,255,.6)' }}>
        ...
        <div className="rounded-xl p-6 mt-10" style={{ background: 'rgba(99,102,241,.08)', border: '1px solid rgba(99,102,241,.2)' }}>
          <h3 className="font-semibold text-white mb-2">Compress your PDF now</h3>
