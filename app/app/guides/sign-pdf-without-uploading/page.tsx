      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <section className="mb-10">
          ...
          <p className="leading-relaxed mb-4" style={{ color: 'rgba(255,255,255,.6)' }}>
            ...
            a JavaScript library called <strong className="text-white">pdf-lib</strong>. All rendering, signature drawing,
        ...
        <section className="mb-10">
          ...
          <ol className="space-y-4" style={{ color: 'rgba(255,255,255,.6)' }}>
            {[
              {
              ...
              <li key={i} className="flex gap-4">
                <span
                  className="w-7 h-7 rounded-full font-bold text-sm flex items-center justify-center shrink-0 mt-0.5"
        ...
        <div className="rounded-xl p-6 mt-10" style={{ background: 'rgba(99,102,241,.08)', border: '1px solid rgba(99,102,241,.2)' }}>
          <h3 className="font-semibold text-white mb-2">Sign your PDF now — no upload needed</h3>
