      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Patient intake forms</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Consent forms and authorisations</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Records and correspondence</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Combining and splitting clinical documents</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-10">
          <div className="bg-indigo-50 rounded-xl p-6">
            <h3 className="font-semibold text-gray-800 mb-2">Edit PDFs without uploading</h3>
          ...
          <div className="bg-indigo-50 rounded-xl p-6">
            <h3 className="font-semibold text-gray-800 mb-2">Merge or split PDFs</h3>
            <p className="text-sm text-gray-600 mb-4">
