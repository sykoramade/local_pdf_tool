      ...
      <article className="max-w-2xl mx-auto px-6 py-16">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">HR departments</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Legal and compliance teams</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Healthcare</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-gray-700 mb-2">Finance and accounting</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-10">
          ...
          <div className="bg-indigo-50 rounded-xl p-6">
            <h3 className="font-semibold text-gray-800 mb-2">Sign PDFs without uploading</h3>
            <p className="text-sm text-gray-600 mb-4">
